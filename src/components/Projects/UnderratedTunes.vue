<template>
    <div class="d-flex flex-column align-items-center" id="UnderratedTunes">
        ...
        <div>
            <a href="https://github.com/beshup/UnderratedTunes"><font-awesome-icon class="mt-1 mr-1 github icon" :icon="['fab','github']" size="2x"/></a>
            <a href="http://www.underratedtunes.com/tunes"><font-awesome-icon class="mt-1 icon" icon="globe" size="2x" /></a>
        </div>
